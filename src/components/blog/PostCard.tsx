      ...
      >
        ...
        {hasCover && (
          ...
          >
            ...
            <Image src={post.coverImage!} alt={post.title} fill className="object-cover transition-transform duration-500 group-hover:scale-105" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 28vw, 400px" />
          </Link>
        )}
